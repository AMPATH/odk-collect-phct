...
public class FormHandler {
    ...
    public void initialize(Context context) {
        ...
        //evaluate a check-digit constraint
        ec.addFunctionHandler(new CheckDigitFunction());
        
        //evaluate a unique entry 
        SharedConstants.dbCtx=context;
        ec.addFunctionHandler(new UniqueFunction());
    ...
    public boolean exportData(String answerPath, Context context, boolean done) {
        ...
        fda.open();
        Log.e("carl", "exporting to... " + answerPath);
