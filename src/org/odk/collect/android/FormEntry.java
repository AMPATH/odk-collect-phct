...
public class FormEntry extends Activity implements AnimationListener, FormLoaderListener {
    ...
    public static final int MENU_HELP_TEXT = Menu.FIRST + 4;
    public static final int MENU_MARK_COMPLETE = Menu.FIRST + 5;
    ...
    public void initializeVariables() {
        ...
        SharedConstants.tempIDs = new ArrayList<String>();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // menu.add(0, MENU_LANGUAGES, 0,
        // getString(R.string.change_language)).setIcon(android.R.drawable.ic_menu_more);
        menu.add(0, MENU_HELP_TEXT, 0, getString(R.string.help_text)).setIcon(
                android.R.drawable.ic_menu_help);
        menu.add(0, MENU_QUIT, 0, getString(R.string.quit_entry)).setIcon(
                android.R.drawable.ic_menu_save);
        menu.add(0, MENU_MARK_COMPLETE, 0, "Mark Complete and Exit").setIcon(
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (isQuestionView()) {
            ...
            if (menu.findItem(MENU_MARK_COMPLETE) == null) {
                menu.add(0, MENU_MARK_COMPLETE, 0, "Mark Complete and Exit").setIcon(
                        android.R.drawable.ic_menu_agenda);
            }
            ...
            menu.removeItem(MENU_HELP_TEXT);
            menu.removeItem(MENU_MARK_COMPLETE);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case MENU_QUIT:
                ...
                return true;
            case MENU_MARK_COMPLETE:
                createMarkCompleteDialog();
                return true;
        }
    ...
    private void createConstraintDialog(PromptElement p, int saveStatus) {
        ...
        mAlertDialog.setButton(Dialog.BUTTON_NEUTRAL, getString(R.string.ok), constraintListener);
        mAlertDialog.setInverseBackgroundForced(true);
        mAlertDialog.show();
        mAlertDialog.getButton(Dialog.BUTTON_NEUTRAL).setFocusableInTouchMode(true);
        mAlertDialog.getButton(Dialog.BUTTON_NEUTRAL).requestFocus();
        mBeenSwiped = false;
    }
    ...
    private void createRepeatDialog(PromptElement p) {
            ...
            public void onClick(DialogInterface dialog, int i) {
                switch (i) {
                    case DialogInterface.BUTTON_POSITIVE: // yes, repeat
                        ...
                        if (SharedConstants.reviews != null) SharedConstants.reviews.clear();
        ...
        mAlertDialog.setInverseBackgroundForced(false);
        mAlertDialog.show();
        mAlertDialog.getButton(Dialog.BUTTON_NEGATIVE).requestFocus();
        mBeenSwiped = false;
    }
                    ...
                    case DialogInterface.BUTTON1: // yes
                        ...
                        int saveStatus =
                                mFormHandler.saveAnswer(p, ((QuestionView) mCurrentView)
                                        .getAnswer(), true);
                        Log.e("carl", "save satatus is " + saveStatus + " and okay is " + SharedConstants.ANSWER_OK);
                        if (saveStatus != SharedConstants.ANSWER_OK) {
                            createConstraintDialog(p, saveStatus);
                            return;
                        } else {
     ...
     * Confirm save and quit dialog
     */
    private void createMarkCompleteDialog() {
        mAlertDialog = new AlertDialog.Builder(this).create();
        mAlertDialog.setMessage("Are you sure you want to Mark Complete and Exit?");
        DialogInterface.OnClickListener quitListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                switch (i) {
                    case DialogInterface.BUTTON1: // yes
                        ...
                        fda.open();
                        Log.e("carl", "file answers path = " + mAnswersPath);
    ...
    public void onAnimationEnd(Animation arg0) {
        mBeenSwiped = false;
        if (mCurrentView instanceof QuestionView) {
            Log.e("carl", "grabbing focus");
            ((QuestionView) mCurrentView).grabFocus();
        }
    }
    ...
    public void loadingComplete(FormHandler formHandler) {
        ...
        if (formHandler == null) {
            ...
            if (mInstancePath != null) {
                ...
                Log.d("carl", "answers path = " + mAnswersPath);
            } else {
                ...
                if (FileUtils.createFolder(path)) {
                    mAnswersPath = path;
                    Log.i("carl", "answers path 1= " + mAnswersPath);
                }
            }
            refreshCurrentView();
        }
