...
public class WidgetFactory {
    ...
    static public IQuestionWidget createWidgetFromPrompt(PromptElement p, Context context) {
        ...
        SharedConstants.alertCtx = context;
        switch (p.getQuestionType()) {
            case Constants.CONTROL_INPUT:
                switch (p.getAnswerType()) {
    				...
    				case Constants.DATATYPE_REVIEW:
    					...
    					break;
                    default:
		               if (p.getInstanceNode().getName().equalsIgnoreCase(SharedConstants.VILLAGE_FIELD))
						questionWidget = new AutoCompleteWidget(context);
					else
            ...
            case Constants.CONTROL_SELECT_ONE:
               /* String appearanceAttr = p.getQuestionDef().getAppearanceAttr() != null ? p
    					.getQuestionDef().getAppearanceAttr()
    					: "full";
    			if (appearanceAttr.equalsIgnoreCase("minimal"))
    				questionWidget = new SelectOneComboWidget(context);
    			else*/
