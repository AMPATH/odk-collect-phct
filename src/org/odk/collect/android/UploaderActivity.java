...
public class UploaderActivity extends Activity implements UploaderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toUpload = FileUtils.getFilesAsArrayList(SharedConstants.ANSWERS_PATH);
        Intent i = this.getIntent();
        mAuth=i.getStringExtra("credentials");
        ...
        if (mUploaderTask == null) {
            ...
            Log.i(t, "Uploading to server: " + server);
            mUploaderTask.setUploadServer(server);
            mUploaderTask.setLoginDetails(mAuth);
